        ...
        {activeTab === 'main' && (
          <>
            <section>
              ...
              <div className="body">
                <Item>
                  <label htmlFor="theme_name" className="title">
                    テーマ
                  </label>
                  <div>
                    <select
                ...
                <Item>
                  <label htmlFor="max_chat_item_num" className="title">
                    表示上限
                  </label>
                  <div>
                    <div className="unit">
                      <Input1
                        type="number"
                        name="max_chat_item_num"
                        id="max_chat_item_num"
                        min="50"
                        max="800"
                        step="50"
                        defaultValue={copiedS.maxChatItemNum}
                        onChange={(event) => {
                          copiedS.maxChatItemNum = Number.parseInt(
                            event.target.value
                          );
                        }}
                ...
                <Item>
                  ...
                  <div>
                    <Switch htmlFor="use_smooth_scroll">
                      <input
                        type="checkbox"
                        name="use_smooth_scroll"
                        id="use_smooth_scroll"
                        defaultChecked={copiedS.useSmoothScroll}
                        onChange={(event) => {
                          copiedS.useSmoothScroll = event.target.checked;
                        }}
                      />
                  ...
                  <div>
                    <Switch htmlFor="update_check">
                      <input
                        ...
                        onChange={(event) => {
                          copiedS.updateCheck = event.target.checked;
                        }}
                      />
                      <span className="slider"></span>
                    </Switch>
                    <p className="description">
                      起動時に新しいバージョンがないかチェックします
                      <br />
                ...
                <Item>
                  <label htmlFor="interval_ms" className="title">
                    チャット取得間隔
                  </label>
                  <div>
                    <div className="unit">
                      <Input1
                        ...
                        onChange={(event) => {
                          copiedS.intervalMs = Number.parseInt(
                            event.target.value
                          );
                        }}
              ...
              <Item>
                ...
                <div>
                  <Switch htmlFor="api_server__enable">
                    <input
                      type="checkbox"
                      name="api_server__enable"
                      id="api_server__enable"
                      defaultChecked={copiedS.apiServer.enable}
                      onChange={(event) => {
                        copiedS.apiServer.enable = event.target.checked;
                      }}
                    />
                    <span className="slider"></span>
                  </Switch>
                  <p className="description">
                    OBSなどにコメントを表示する場合はON(変更時は再起動が必要)
                  </p>
                </div>
              </Item>
              <Item>
                <label htmlFor="api_server__port" className="title">
                  ポート番号
                </label>
                <div>
                  <Input1
                    type="number"
                    name="api_server__port"
                    id="api_server__port"
                    min="49152"
                    max="65535"
                    defaultValue={copiedS.apiServer.port}
                    onChange={(event) => {
                      copiedS.apiServer.port = Number.parseInt(
                        event.target.value
                      );
                    }}
              ...
              <Item>
                ...
                <div>
                  <Switch htmlFor="bouyomi__enable">
                    <input
                      type="checkbox"
                      name="bouyomi__enable"
                      id="bouyomi__enable"
                      defaultChecked={copiedS.bouyomi.enable}
                      onChange={(event) => {
                        copiedS.bouyomi.enable = event.target.checked;
                      }}
                    />
                    <span className="slider"></span>
                  </Switch>
                  <p className="description">
                    棒読みちゃんにチャットを読み上げてもらう場合はON
                  </p>
                </div>
              </Item>
              <Item>
                <label htmlFor="bouyomi__port" className="title">
                  ポート番号
                </label>
                <div>
                  <Input1
                    ...
                    onChange={(event) => {
                      copiedS.bouyomi.port = Number.parseInt(
                        event.target.value
                      );
                    }}
              ...
              <Item>
                ...
                <div>
                  {(
                    ...
                    return (
                      <div key={i} style={{ width: '100%' }}>
                        <label htmlFor={prefix} className="sub-title">
                          {name}
                        </label>
                        <FormatWrap>
                          <Input2
                            ...
                            onChange={(event) => {
                              copiedS.bouyomi.youtube[key] = event.target.value;
                            }}
                            placeholder={defVal}
                          />
                          <Btn2
                      ...
                      <div key={i} style={{ width: '100%' }}>
                        ...
                        <FormatWrap>
                          <Input2
                            ...
                            defaultValue={copiedVal}
                            onChange={(event) => {
                              copiedS.bouyomi.twitch[key] = event.target.value;
                            }}
                            placeholder={defVal}
                          />
                          <Btn2
                  ...
                  <p className="description">
                    ...
                    $(Name): 投稿者名
                    <br />
                    $(Amount): スパチャ金額 or ビッツ
                    <br />
                    $(GiftNum): ギフトの個数(YouTube非対応)
                    <br />
                    に置き換えて読み上げます
                    <br />
                    ※ 空白にすると読み上げなくなります
        ...
        <div className="wrap">
          <div className="mr">
            <Btn1
              className="a warn"
              onClick={() =>
                closeHandler({ ...copiedS }, true, scrollY.current, activeTab)
              }
            >
              キャンセル
            </Btn1>
          ...
          <Btn1
            className="large"
            onClick={() =>
              closeHandler({ ...copiedS }, false, scrollY.current, activeTab)
            }
          >
            保存
          </Btn1>
...
export const Main = styled.div`
  ...
  overflow-y: scroll;
  overflow-x: auto;
  box-shadow: inset 0 ${ss}px ${ss}px -${ss}px var(--c-shadow),
