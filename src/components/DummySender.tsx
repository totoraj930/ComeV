...
import {
  ChatItem,
  createDummyYTChatItem,
  createDummyYTGiftItem,
  createDummyYTMembershipItem,
  createDummyYTStickerItem,
  createDummyYTSuperChatItem,
...
export const DummySender: React.FC = () => {
  ...
  const sendDummyChat = useCallback(
    (
      ...
      const sChat = createDummyYTSuperChatItem(
        r() ? 'これはダミーのスーパーチャット' : null,
        null
      );
      ...
      switch (type) {
        ...
        case 'random': {
          item = r(0.3) ? (r(0.5) ? sChat : sChat2) : chat;
          break;
        }
        default: {
          item = chat;
